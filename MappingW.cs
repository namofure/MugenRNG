    ...
    public class MappingW
    {
        ...
        public void DrawRoom(Graphics g, int x, int y, int z, byte Val, Room R)
        {
            ...
            if (Val == 0xFF) //エレベータ室
            {
                using (Brush Brush = new SolidBrush(Color.Black))
                {
                    Rectangle All = new Rectangle((BaseX + 1) * CellSize, BaseY * CellSize, 70, 10);
                    g.FillRectangle(Brush, All);
                }
                return;
            }
            ...
            if (Val == 0x12) //かいりき部屋
            {
                using (Brush Brush = new SolidBrush(Color.Black))
                {
                    Rectangle TopLeft = new Rectangle((BaseX + 2) * CellSize, (BaseY + 2) * CellSize, 20, 20); //左上
                    g.FillRectangle(Brush, TopLeft);

                    Rectangle TopRight = new Rectangle((BaseX + 5) * CellSize, (BaseY + 2) * CellSize, 20, 20); //右上
                    g.FillRectangle(Brush, TopRight);

                    Rectangle BottomLeft = new Rectangle((BaseX + 2) * CellSize, (BaseY + 5) * CellSize, 20, 20); //左下 
                    g.FillRectangle(Brush, BottomLeft);

                    Rectangle BottomRight = new Rectangle((BaseX + 5) * CellSize, (BaseY + 5) * CellSize, 20, 20); //右下
                    g.FillRectangle(Brush, BottomRight);
                ...
                {
                    Rectangle TopLeft = new Rectangle((BaseX + 1) * CellSize, (BaseY + 1) * CellSize, 10, 10); //左上
                    g.FillRectangle(Brush, TopLeft);

                    Rectangle TopRight = new Rectangle((BaseX + 7) * CellSize, (BaseY + 1) * CellSize, 10, 10); //右上
                    g.FillRectangle(Brush, TopRight);

                    Rectangle BottomLeft = new Rectangle((BaseX + 1) * CellSize, (BaseY + 7) * CellSize, 10, 10); //左下 
                    g.FillRectangle(Brush, BottomLeft);

                    Rectangle BottomRight = new Rectangle((BaseX + 7) * CellSize, (BaseY + 7) * CellSize, 10, 10); //右下
                    g.FillRectangle(Brush, BottomRight);
            ...
            if (Val == 0x11) //いあいぎり部屋
            {
                using (Brush Brush = new SolidBrush(Color.Gray))
                {
                    Rectangle TopLeft = new Rectangle((BaseX + 2) * CellSize, (BaseY + 1) * CellSize, 20, 20); //左上
                    g.FillRectangle(Brush, TopLeft);

                    Rectangle TopRight = new Rectangle((BaseX + 6) * CellSize, (BaseY + 2) * CellSize, 20, 20); //右上
                    g.FillRectangle(Brush, TopRight);

                    Rectangle BottomLeft = new Rectangle((BaseX + 1) * CellSize, (BaseY + 5) * CellSize, 20, 20); //左下 
                    g.FillRectangle(Brush, BottomLeft);

                    Rectangle BottomRight = new Rectangle((BaseX + 5) * CellSize, (BaseY + 6) * CellSize, 20, 20); //右下
                    g.FillRectangle(Brush, BottomRight);
                }

                using (Brush Brush = new SolidBrush(Color.Black))
                {
                    Rectangle TopLeft = new Rectangle((BaseX + 1) * CellSize, (BaseY + 3) * CellSize, 10, 10); //左上
                    g.FillRectangle(Brush, TopLeft);

                    Rectangle TopRight = new Rectangle((BaseX + 5) * CellSize, (BaseY + 1) * CellSize, 10, 10); //右上
                    g.FillRectangle(Brush, TopRight);

                    Rectangle BottomLeft = new Rectangle((BaseX + 3) * CellSize, (BaseY + 7) * CellSize, 10, 10); //左下 
                    g.FillRectangle(Brush, BottomLeft);

                    Rectangle BottomRight = new Rectangle((BaseX +7) * CellSize, (BaseY + 5) * CellSize, 10, 10); //右下
                    g.FillRectangle(Brush, BottomRight);
                }
                return;
            }
